...
describe('Non Fungible Token - Mintable & Burnable', async () => {
    const accounts = utils.getDefaultAccounts();
    const ownerAccount = accounts[0], nonOwnerAccount = accounts[1], operatorAccount = accounts[3];
    ...
    describe('Deploy contract', async () => {
        it('deploying successfully', async () => {
            await nonFungibleMintableBurnableInstance.deploy(["Non Fungible Token - Mintable & Burnable", "NFT"], {onAccount: ownerAccount});
        });
    });
           ...
           describe('Mint', () => {
            ...
            describe('Burn', () => {
                it(`shouldn't burn token from non-owner`, async () => {
                    await assertNode.rejects(nonFungibleMintableBurnableInstance.methods.burn(1, {onAccount: nonOwnerAccount}), (err) => {
