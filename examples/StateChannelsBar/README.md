...
To open and close a state channel, 30k AEs are needed.

The app demonstrates how you deposit some AEs, create on chain tx and after that you can purchase some items/products from "the bar " where all txs are very fast and transparent. You have basic history and can watch your balance
